...
<!-- 게시판 페이지 시작 -->
	<section class="notice">
		...
		<div id="board-list">
			<div class="container">
				<form name="frmArticle" method="post" action="${contextPath}/qBoard/addArticle.do" enctype="multipart/form-data">
					<table align="center">
						<tbody>	
							<tr>
							...
							<tr>
								...
								<td width="200">
									<select name="i_name">
										...
										<c:forEach var="itemList" begin="1" items="${allItemList}">
											<option value="${itemList.i_name}">${itemList.i_name}</option>
										</c:forEach>
									</select>
								</td>
							</tr>
						...
						<tfoot>
							<tr id="all_btn">
					               ...
					               <input class="board_btn" type="submit" value="문의하기">
					               <input class="board_btn" type="button" value="목록으로" onclick="listView(this.form)">
					            </td>
						  	</tr>
					  	</tfoot>
					</table>
