...
<body>
    ...
    <img class="chat" src="./img/chat.jpg" />
</body>
</html>
<script>
    $(".chat").on({
        "click" : function() {
            if ($(this).attr("src") == "./resources/img/chat.jpg") {
                $(".chat").attr("src", "./resources/img/chathide.jpg");
                $("#_chatbox").css("display", "block");
            } else if ($(this).attr("src") == "./resources/img/chathide.jpg") {
...
<script type="text/javascript">
    ...
    var webSocket = new WebSocket('ws://localhost:8090//chatService/broadcasting');
